                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('properties.update', $property->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ $property->name }}" class="form-control" autofocus>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" step="any" name="price" value="{{ $property->price }}" id="price" class="form-control">
                            @error('price')
                                <span class="small text-danger fw-bold"> {{ $message }} </span>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="address" id="address" value="{{ $property->address }}" class="form-control">
                            @error('address')
                                <span class="small text-danger fw-bold"> {{ $message }} </span>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" value="sale" id="sale" {{ $property->status == 'sale' ? 'checked' : '' }} />
                                <label class="form-check-label" for="sale"> For Sale</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" value="rent" id="rent" {{ $property->status == 'rent' ? 'checked' : '' }} />
                        ...
                        <div class="mb-4">
                            ...
                            <textarea rows="6"name="description" id="description" class="form-control">{{ $property->description }}</textarea>
                            @error('description')
                                <span class="small text-danger fw-bold"> {{ $message }} </span>
                            @enderror
                        </div>
